...
#WCZYTYWANIE DANYCH
df_01 <- read.csv("JC-201701-citibike-tripdata.csv")
df_04 <- read.csv("JC-201704-citibike-tripdata.csv")
df_07 <- read.csv("JC-201707-citibike-tripdata.csv")
df_10 <- read.csv("JC-201710-citibike-tripdata.csv")
df_02 <- read.csv("JC-201702-citibike-tripdata.csv")
df_03 <- read.csv("JC-201703-citibike-tripdata.csv")
df_05 <- read.csv("JC-201705-citibike-tripdata.csv")
df_06 <- read.csv("JC-201706-citibike-tripdata.csv")
df_08 <- read.csv("JC-201708 citibike-tripdata.csv")
df_09 <- read.csv("JC-201709-citibike-tripdata.csv")
df_11 <- read.csv("JC-201711-citibike-tripdata.csv")
df_12 <- read.csv("JC-201712-citibike-tripdata.csv")
